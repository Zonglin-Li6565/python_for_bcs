...
def main():
    # load the data.
    my_data = dl.Dataset(INPUT_FILE_NAME, RANDOM_DATA, TRAINING_PROPORTION,
                         NORMALIZE_METHOD, SVD_DIM, VERBOSE, RANDOM_SEED)

    # compute correlations between features and categories
    # my_data.compute_feature_correlations()

    # plot word scatterplot. by default, performs SVD and plots first 2 SVs.
    # If you want to plot
    # if instead you want to plot specific features, use their numbers as
    # arguments after WORD_LABELS
    ...
    # The first number is the feature number, the second number is the
    # category number
    ...
    # my_knn = knn.Knn(my_data, MIN_MAX_KNN, SIMILARITY_METRIC, VERBOSE,
